...
if __name__ == '__main__':
    ...
    if not args.data_free:
        ...
        input_file = 'Dataset/{}/{}/{}.tsv'.format(args.task, args.input_dir, args.data_type)
        ...
        os.makedirs('Dataset/{}/poisoned_wo_dataset/{}'.format(args.task, args.output_dir), exist_ok=True)
        output_file = 'Dataset/{}/poisoned_wo_dataset/{}/{}.tsv'.format(args.task, args.output_dir, args.data_type)
